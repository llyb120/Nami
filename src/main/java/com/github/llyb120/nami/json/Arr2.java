...
//
//    public Obj2[] oa(){
//        return this.toArray(new Obj2[this.length()]);
//    }
//
////    public List<Obj2>toObjList toObjList(){
////        var list = new ArrayList<Obj2>();
////        for (Object o : this) {
////            if(o instanceof Obj2){
////                list.add((Obj2)o);
////            } else if(o instanceof Map){
////                list.add(new Obj2((Map)o));
////            } else {
////
////            }
////        }
...
//        return this.toArray(new String[this.length()]);
//    }
//
