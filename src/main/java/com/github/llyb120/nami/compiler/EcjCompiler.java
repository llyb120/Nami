...
//import java.util.*;
//
//public class EcjCompiler extends EclipseCompiler {
//    private static Set<SourceVersion> SupportedSourceVersions;
//    protected WeakHashMap<Thread, EcjCompilerImpl> threadCache = new WeakHashMap<>();
//
//    @Override
...
//        EcjCompilerImpl eclipseCompiler = this.threadCache.get(currentThread);
//        if (eclipseCompiler == null) {
//            eclipseCompiler = new EcjCompilerImpl(writerOut, writerErr, false);
...
//        }
//        final EcjCompilerImpl eclipseCompiler2 = new EcjCompilerImpl(writerOut, writerErr, false);
